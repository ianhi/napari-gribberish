...
You can install `napari-gribberish` via [pip]:

```bash
pip install napari-gribberish
```

If napari is not already installed, you can install `napari-gribberish` with napari and Qt via:

```bash
pip install "napari-gribberish[all]"
```
